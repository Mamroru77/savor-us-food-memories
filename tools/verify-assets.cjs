...
// 4. known-critical sample images (web baseline + current native map exports)
const CRITICAL = [
  ...
  '/images/jamie.jpg',
  '/images/alex.jpg',
  '/images/markers/landmark-normal-frame.png',
  '/images/markers/landmark-normal-fallback.png',
  '/images/markers/landmark-selected-frame.png',
  '/images/markers/landmark-selected-fallback.png',
  '/images/markers/stack-button-up.png',
  '/images/markers/stack-button-down.png',
  '/images/markers/stack-anchor.png',
];
