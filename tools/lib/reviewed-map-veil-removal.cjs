...
function historicalContrastView(css,wxml){
 assert.equal(hash(css),'1af64be700166e451ffd3c411f3bb8c936de0d2daf38e5f8eb0a4008e95259de','unreviewed Map stylesheet');
 assert.equal(hash(wxml),'464c48ae3efc36197a54de494efaaddee5616023d4457d5241381437193c9db1','unreviewed Map template');
