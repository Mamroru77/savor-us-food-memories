...
Page({
  data: { theme: 'pearl', dusk: false, ink: '#1b1c1a', muted: '#565752', recent: [], stats: {}, weeklyPhoto: photos.meal, showDot: false },
  ...
  onShow() {
    ...
    this.unbind = store.bind(this, (state) => {
      ...
      return Object.assign(store.themeOf(state), {
        ...
        stats: summary,
        weeklyPhoto: summary.added > 0 ? state.memories[0].photo : photos.meal,
