// Lucide-style 24x24 stroke icons (ISC license, lucide v1.41.0 path data),
// rendered as SVG data URIs so WXML can display them without any webview tricks.
// Generated from node_modules/lucide-react/dist/esm/icons/*.
const icons = {
  ...
  'map-shield': '<path d="M12 2.5C14.6 4.3 17.2 4.8 20 5V12.2C20 17.1 16.2 20.3 12 22C7.8 20.3 4 17.1 4 12.2V5C6.8 4.8 9.4 4.3 12 2.5Z"/><path d="M10 7V10.5C10 12 14 12 14 10.5V7M12 7V16"/>',
  'loader': '<path d="M21 12a9 9 0 1 1-6.219-8.56"/>',
  'trash-2': '<path d="M10 11v6"/><path d="M14 11v6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>',
  'circle-help': '<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>'
};

const EXTRA = { fill: 'none', stroke: '#1b1c1a', strokeWidth: 1.5 };
